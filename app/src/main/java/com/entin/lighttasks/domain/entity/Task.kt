...
data class Task(
    ...
    @ColumnInfo(name = "is_finished", index = true) val isFinished: Boolean,
    @ColumnInfo(name = "is_important", index = true) val isImportant: Boolean,
    ...
    @ColumnInfo(name = "is_task_expired", index = true) val isTaskExpired: Boolean,
